...
function TodoItem({ todo, onToggle, onDelete, onEdit, showLocalTag = false, isToday = false }) {
  ...
  return (
    <div className="relative group">
      <div 
        className={`bg-gray-800 rounded-lg p-4 flex items-center justify-between transition-colors duration-150 ${
          isToday && !isEditing ? 'cursor-pointer hover:bg-gray-750' : 'hover:bg-gray-750'
        }`}
        ...
        {!isEditing && (
          <div className="relative">
            <button
              ...
              className="menu-button p-2 text-gray-400 hover:text-white opacity-0 group-hover:opacity-100
